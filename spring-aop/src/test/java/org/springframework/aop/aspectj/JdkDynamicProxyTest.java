...
import org.springframework.aop.aspectj.annotation.AspectProxyFactoryTests;
 ...
 * @since 13.03.2003
 */
public class JdkDynamicProxyTest extends AbstractAopProxyTests {
	...
	public void testProxyIsJustInterface() throws Throwable {
		AspectProxyFactoryTests.TestBean raw = new AspectProxyFactoryTests.TestBean();
		raw.setAge(32);
		AdvisedSupport pc = new AdvisedSupport(new Class[] {AspectProxyFactoryTests.ITestBean.class});
		pc.setTarget(raw);
		JdkDynamicAopProxy aop = new JdkDynamicAopProxy(pc);

		Object proxy = aop.getProxy();
		assertTrue(proxy instanceof AspectProxyFactoryTests.ITestBean);
		assertTrue(!(proxy instanceof AspectProxyFactoryTests.TestBean));
	}
